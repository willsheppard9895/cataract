...
There were significant main effects for guide, F(1,70) = 5.29, p <.02, $\eta^2$ = .07, and speed, F(1.04,72.59) = 235.21, p <.001, $\eta^2$ = .77, and a guide by speed interaction, F(1.07,74.65) = 10.10, p <.01, $\eta^2$ = .13 but no interactions involving visual condition.
...
A significant main effect of visual condition emerged F(2,142) = 12.61, p <.01, $\eta H$ $\eta^2$ = .15.
...
A significant main effect of visual condition emerged F(1.38,97.77) = 8.94, p <.001, $\eta^2$ = .11.
...
A main effect of shape emerged, F(1,71) = 8.16, p <.01, $\eta^2$ = .10.
...
The main effect of visual condition remained F(1.37,75.07) = 4.66, p <.05, $\eta^2$ = .08, but this was now only driven by a significant difference between binocular vision and the worse eye, p <.05, *Cohen’s d* = .37.
...
```{r eval = TRUE, echo = FALSE, message=FALSE, error= FALSE, warning=FALSE, fig.height=3, fig.width = 8, fig.align='center'}
...
A significant main effect of visual condition emerged, F(2, 58) = 293.37, p <.001, $\eta^2$ 2 = .91.
...
A significant main effect of visual condition was found F(1.51, 43.75) = 74.49, p <.001, $\eta^2$ = 0.72.
...
A significant main effect of visual condition emerged, F (1.66, 48.03) = 45.76, p <.001, $\eta^2$ = 0.61.
...
A significant main effect of visual condition emerged, F (2, 58) = 4.76, p <.05, $\eta^2$ = 0.14. 
...
A main effect of visual condition emerged F (2, 54) = 4.41, p <.05, $\eta^2$ = 0.14.  This was driven by significant differences in scores between no filter and 2 filters, p <.05, *Cohen’s d* = .52, but not between no filter and 1 filter, p =.23, *Cohen’s d* = .23, or 1 filter and 2 filters, p =.19, *Cohen’s d* = 0.33.
...
A significant main effect of visual condition emerged, F (2, 58) = 5.79, p <.01, $\eta^2$ = 0.16.
...
A main effect of visual condition was found F (2, 58) = 6.70, p <.01,  $\eta^2$ = 0.19.
